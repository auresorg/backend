...
final class ProjectController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($user->getProjectsCount() === 1) {
            $this->notificationService->createNotification($user, "Great job! Check your autogenerated resume from the artifacts section 'role resume' tab.", "check-circle");
        }
